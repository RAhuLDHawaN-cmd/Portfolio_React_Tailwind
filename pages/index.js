  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className=" bg-slate-50 px-10 dark:bg-zinc-900 md:px-20 lg:px-40">
        ...
        <section id="services">
          <div>
            <h3 className="text-3xl py-1 dark:text-white heads">Services I offer</h3>
          ...
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10  dark:bg-zinc-700 flex-1">
              ...
              <h4 className="py-4 text-teal-600 dark:text-teal-400 text-xl">Design Tools I Use</h4>
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-zinc-700 flex-1">
              ...
              <h3 className="text-2xl font-medium pt-8 pb-2 dark:text-gray-200 Roboto ">Consulting</h3>
              <p className="py-2 dark:text-gray-200 Roboto">
