      ...
      <main className="bg-white px-10 dark:bg-zinc-900 md:px-20 lg:px-40">
        <section className="min-h-screen " id="banner">
          <nav className="bg-white pt-10 mb-12 flex justify-evenly sticky top-0 z-50 dark:bg-zinc-900 dark:text-white ">
            <h1 className="font-burtons pl-5 text-xl">
            <a href="/">MatchStick</a>
            </h1>
...
Over couple of years, I acquired extensive experience as a Full-Stack Developer built two start-ups, which empowered me to devise a process that brings out the best of my skills. Working on building webapps powered by GPT-4 and Open AI</h4>
        ...
        <section className="py-10" id="portfolio">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            ...
            <div className="basis-1/3 flex-1">
            <a href="https://gptsynthesis.netlify.app/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
              <Image
                className="rounded-lg object-cover zoom"
                width={"100%"}
                height={"100%"}
            ...
            <div className="basis-1/3 flex-1">
            <a href="https://chat-worldd.netlify.app" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
              <Image
                className="rounded-lg object-cover zoom"
                width={"100%"}
                height={"100%"}
            ...
            <div className="basis-1/3 flex-1">
            <a href="https://gptsysnthesis.netlify.app/" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
